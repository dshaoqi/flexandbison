...
{
  "$end", "error", "$undefined", "STRUCT", "CONST", "UNSIGNED", "LONG",
  "INT", "VOID", "WORD", "';'", "'{'", "'}'", "'*'", "$accept",
  "declareStruct", "block", "statements", "declareVar", "type", YY_NULLPTR
};
#endif
...
static const yytype_int8 yydefact[] =
{
      ...
      10,    13,     0,     4,     0,     2,     0,     0,     3,     5,
       0,     0,    14,     0,     0,     6,     0,     8,     9,     7
};
...
yyreduce:
  ...
  case 2:
#line 44 "test.y"
                                      { (yyval.sm)=null;printf("struct %s is defined",(yyvsp[-1].smi).name);}
...
#line 46 "test.y"
                        {}
#line 1356 "test.tab.c"
    break;

  case 5:
#line 47 "test.y"
                                   {}
#line 1362 "test.tab.c"
    break;
...
#line 54 "test.y"
            { (yyval.type)=(yyvsp[0].type); }
#line 1404 "test.tab.c"
    break;

  case 13:
#line 55 "test.y"
            { (yyval.type)=(yyvsp[0].type); }
#line 1410 "test.tab.c"
    break;
